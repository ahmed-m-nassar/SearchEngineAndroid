...
public class EndPointUtilities {
    public static final  String BASE_URL = "https://401e1e11.ngrok.io/search/";
    ...
    public static final  String SEARCH_SUGGESTIONS = "suggest";

    public static final  String SEARCH_QUERY_PARAMETER = "search_query";
